    ...
    public class Function
    {
        ...
        public SkillResponse FunctionHandler(SkillRequest input, ILambdaContext context)
        {
            ...
            if (input.GetRequestType() == typeof(LaunchRequest))
            {
                ...
                string firstText = "Welcome to the Virtual Suspect experience. ";
                string suspectInformation = "You are talking with Joanna Brando, she says someone is trying to kill her. ";
                string lastText = "Talk to her to find out more.";
            ...
            else if (input.GetRequestType() == typeof(IntentRequest))
            {
                ...
                switch (intentRequest.Intent.Name)
                {
                    case "AMAZON.StopIntent":
                        ...
                        speechText = "You are now leaving the Virtual Suspect. Did you win?";
                    ...
                    case "AMAZON.HelpIntent":
                        ...
                        speechText = "You can ask the suspect questions to find out more.";
                    ...
                    case "AMAZON.FallbackIntent":
                        ...
                        //pregen answer
                        speechText = "I don't know if I understood that right";
                    ...
                    case "GreetingIntent":
                        ...
                        speechText = "Hello... Why are you wasting time with formalities? You do understand someone is trying to kill me?";
                    ...
                    case "IntrospectionIntent":
                        ...
                        speechText = "I am stressed. Please help me";
        ...
        private bool AddQueryConditions(QueryDto query, IntentRequest intent, ILambdaLogger log, out string failLog)
        {
            ...
            // Hard Coded parts to be wary of
                ...
                if (KnownSlot(intent_slots["theme"]))
                {
                    ...
                    if (CheckDirectPronoun(theme))
                    {
                        ...
                        else
                        {
                            ...
                            //hard coded value to be wary of
        ...
        {
            //return "<voice name='" + name + "'>" + "<audio src='soundbank://soundlibrary/transportation/amzn_sfx_car_accelerate_01'/>" + speech  + "</voice>";
